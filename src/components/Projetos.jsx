...
import { FaGithub, FaExternalLinkAlt, FaDatabase, FaChartBar, FaBoxes } from 'react-icons/fa'
...
const projects = [
  {
    ...
    description:
      'Sistema completo para controle de estoque e cálculo de acuracidade, mostrando sobras, faltas e percentual de desvio em tempo real.',
    ...
    features: ['Controle de entrada/saída', 'Cálculo automático', 'Relatórios de desvio'],
    github: '#',
    demo: '#',
  },
  {
    id: '02',
    icon: FaChartBar,
    title: 'Dashboard de Acuracidade',
    subtitle: 'Analytics & Business Intelligence',
    description:
      'Dashboard interativo com gráficos e indicadores de inventário, construído com SQL Server e React para tomada de decisões ágil.',
    ...
    features: ['Gráficos interativos', 'KPIs em tempo real', 'Filtros dinâmicos'],
    github: '#',
    demo: '#',
  },
  {
    ...
    description:
      'Sistema integrado ao SQL Server para consultar vendas, filtrar por período e gerar relatórios exportáveis com análise detalhada.',
    tags: ['React', 'SQL Server', 'Node.js', 'JavaScript'],
    tagIcons: [SiReact, FaDatabase, SiNodedotjs, SiJavascript],
    color: '#00d4ff',
    gradient: 'from-[rgba(0,212,255,0.15)] to-[rgba(0,212,255,0.02)]',
    features: ['Consultas avançadas', 'Geração de relatórios', 'Filtros por período'],
    github: '#',
    demo: '#',
  },
]
      ...
      <div className="max-w-6xl mx-auto relative">
        ...
        >
          ...
          <p className="font-body text-slate-500 mt-8 max-w-md mx-auto">
            Projetos práticos desenvolvidos durante minha jornada de aprendizado
          </p>
        </motion.div>
